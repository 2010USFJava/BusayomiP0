...
public class Menu {
	...
	public static void startMenu() {
		...
		case "u":
			...
			break;
		case "a":
			System.out.println("Admin Login in with your username and password!");
			adminMenu();
			transactions(a);
			break;
		case "l":
	...
	private static void registerNewUser() {
		System.out.println("Create a new user's Account!");
		...
		System.out.println("Please enter age: ");
			...
			if(option.equalsIgnoreCase("y")) {
				...
				Users u1=new Users();
				try {
					adi.createNewUsers(u1.getUsersId());
				} catch (SQLException e) {
					// TODO Auto-generated catch block
					e.printStackTrace();
				}*/
	...
	public static void transactions(Account account) {
		...
		case "b":
			System.out.println(account.getBalance());
			double amountb = scan.nextDouble();
			try {
				adi.createAccount(amountb);
			} catch (SQLException e) {
				// TODO Auto-generated catch block
				e.printStackTrace();
			}
	...
	public static void viewCustomerInfo() {
		...
		try {
			u = uadi.findUsersbyName(firstName);
	...
	public static void adminMenu() {
		...
		default:
			...
			adminMenu();//Return to startmenu if choice not match
			break;
		}}
